  ...
  for(k in 1:10){
    ...
    for(iter in 1:30){
      ...
      ###rf tune
      set.seed(2019)
      rf.grid.search = expand.grid(ntree = (1:25)*20, mtry = c(2,4))
      ...
      gbm.grid.search = expand.grid(interaction.depth=c(2,6),
      ...
      ###lgb tune
      lgb.grid.search <- expand.grid(num_leaves = c(2^2,2^6), #xgboost max_depth, light gbm is leaf wise
  ...
  for(i in 1:10){
    ...
    dir.boxplot = paste0("C:/Users/User/Desktop/jb/image/result.boxplot",i,".png")
  ...
  write.table(result.mean.mat, file = "C:/Users/User/Desktop/jb/table/result.mean.table.csv", append = TRUE,sep = ",",
  ...
  for(i in 1:10){
    ...
    write.table(final.result.table , file = "C:/Users/User/Desktop/jb/table/final.result.table.csv", append = TRUE,sep = ",",
                col.names = TRUE,row.names = FALSE)
  }
  ...
  for(i in 1:10){
    ...
    write.table(glm.coef, file = "C:/Users/User/Desktop/jb/table/glm.coef.csv", append = TRUE,sep = ",",
                col.names = TRUE,row.names = TRUE)
  }

  
  
  save.image("C:/Users/User/Desktop/jb/paper/paper.2019.08.01.data.image.RData")
